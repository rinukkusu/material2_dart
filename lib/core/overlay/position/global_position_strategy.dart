 ...
 *
 * Dart note: In Dart style, some method like fixed() should not return `this`
 * in CQS principle, and caller can use cascade instead.
 * But here keeping the original interface deliberately.
 */
